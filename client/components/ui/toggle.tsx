...
export const Toggle = React.forwardRef<HTMLButtonElement, ToggleProps>(
  (
    ...
    const activeColor = disabled
      ? "bg-light-purple/40 border-light-purple/40"
      : "bg-light-purple border-light-purple";
    const inactiveColor = disabled
      ? "bg-white border-light-purple/40"
      : "bg-white border-light-purple/40";
    ...
    return (
      <div className={cn("flex items-center gap-2", className)}>
        {leftIcon !== undefined ? (
          ...
          <LightModeIcon className={disabled ? "opacity-40" : ""} />
        )}
        ...
        {rightIcon !== undefined ? (
          ...
          <DarkModeIcon className={disabled ? "opacity-40" : ""} />
        )}
      </div>
    );
  },
