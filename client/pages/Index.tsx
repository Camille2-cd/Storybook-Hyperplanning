    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="space-y-16">
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Primary Buttons</h2>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Secondary Buttons</h2>
            <div className="flex flex-wrap gap-4 items-center">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Tertiary Buttons</h2>
            <div className="flex flex-wrap gap-4 items-center">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Link Buttons</h2>
            <div className="flex flex-wrap gap-4 items-center">
          ...
          <section className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8 sm:p-12">
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">Interactive Demo</h2>
            <p className="text-gray-600 mb-8">Click the buttons below to see them in action</p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">Responsive Design</h2>
            <p className="text-gray-600 mb-8">
              Buttons automatically adjust their size based on screen width. Mobile devices use 14px font size,
              while tablets and desktops use 16px.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">Mobile (auto)</p>
                <Button variant="primary" size="mobile" label="Button" />
              </div>
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">Desktop</p>
                <Button variant="primary" size="desktop" label="Button" />
              </div>
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">With Custom Icon</p>
                <Button 
                  variant="primary" 
                  label="Custom" 
                  icon={
        ...
        <div className="mt-24 text-center">
          <div className="inline-block bg-gray-50 rounded-2xl p-8 sm:p-12">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl">
              Fully responsive, accessible, and customizable button component built with React, TypeScript, and Tailwind CSS
            </p>
            <Button variant="primary" label="View Documentation" iconPosition="right" />
          </div>
        </div>
      </div>
    </div>
