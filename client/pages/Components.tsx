    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="space-y-16">
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Basic Checkboxes</h2>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Disabled States</h2>
            <div className="space-y-6">
              <div className="flex flex-wrap gap-8 items-center">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Interactive Demo</h2>
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8 sm:p-12">
              <p className="text-gray-600 mb-6">Toggle these checkboxes to see them in action:</p>
              ...
              <div className="mt-8 p-4 bg-white rounded-lg">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>Newsletter: {checked1 ? '✓ Subscribed' : '✗ Not subscribed'}</li>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Responsive Design</h2>
            <p className="text-gray-600 mb-8">
              Checkboxes automatically adjust their size based on screen width:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">Desktop/Tablet</p>
                <p className="text-xs text-gray-500 mb-4">24px icon, 18px text</p>
                <Checkbox label="Checkbox" />
              </div>
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">Mobile</p>
                <p className="text-xs text-gray-500 mb-4">32px icon, 16px text</p>
                <Checkbox label="Checkbox" />
              </div>
              <div className="p-6 border-2 border-gray-200 rounded-lg">
                <p className="text-sm font-medium text-gray-500 mb-4">Checked State</p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Form Example</h2>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Without Labels</h2>
        ...
        <div className="mt-24 text-center">
          <div className="inline-block bg-gray-50 rounded-2xl p-8 sm:p-12">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl">
              Built to match the Figma design exactly, with responsive sizing and proper color states
            </p>
